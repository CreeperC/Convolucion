...
int red()
{
    ...
    gradiente_neurona1_capaoculta=matrix_product(escalar(matrix_init(1,df.registros,dL),salida.pesos[0]),O21_dw);

    gradiente_neurona2_capaoculta=matrix_product(escalar(matrix_init(1,df.registros,dL),salida.pesos[1]),O21_dw);
